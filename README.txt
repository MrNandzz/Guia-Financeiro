...
Ao cadastrar uma conta fixa ou uma aquisição parcelada, dá pra vincular
a um cartão (além do banco, se quiser os dois). O "usado" mostrado no
cartão é a soma do que ainda falta pagar nas contas com prazo e
aquisições vinculadas a ele — ou seja, o quanto desse limite ainda está
comprometido em parcelamentos em aberto.
...
cartões etc.) ficam salvos com localStorage, direto no navegador/app
instalado do seu iPhone. Eles continuam lá mesmo depois de fechar o app,
trocar de tela ou reiniciar o aparelho.
...
nuvem automático nesta versão. Fotos de cartões ocupam mais espaço que
o resto dos dados — se você notar o armazenamento ficando cheio, use
fotos menores ou remova fotos de cartões que não precisa mais.
